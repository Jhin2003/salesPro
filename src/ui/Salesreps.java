...
public class Salesreps extends JPanel {
    ...
    public Salesreps(JFrame frame, Records records){
        this.frame = frame;
        ...
        JLabel currentRecordsLabel = new JLabel("Sales Reps");
        ...
        JButton addSalesrepButton = new JButton("Add New Salesrep");
        addSalesrepButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                JLabel addnewSalesrepLabel = new JLabel("Add New Sales representative");
                ...
                submitButton.addActionListener(new ActionListener() {
                    ...
                    public void actionPerformed(ActionEvent e) {
                        ...
                        if(nameText.isEmpty() || contactText.isEmpty() || addressText.isEmpty()){
                            ...
                            salesrepDAO.addSalesrep(new SalesrepDTO(name, contact, address));
        ...
        List<SalesrepDTO> salesreps = salesrepDAO.getAllSalesreps();
        Object[][] data = new Object[salesreps.size()][4];
        for (int i = 0; i < salesreps.size(); i++) {
            SalesrepDTO salesrep = salesreps.get(i);
            data[i][0] = salesrep.getId();
            data[i][1] = salesrep.getName();
            data[i][2] = salesrep.getContact();
            data[i][3] = salesrep.getAddress();
        }
            ...
            public void mouseClicked(MouseEvent e) {
                if (e.getClickCount() == 1) { // Single-click
                    ...
                    if (selectedRow != -1) {
                        ...
                        String[] columnNames = {"ID", "Product Sold", "Quantity", "Discount Code", "Total Amount", "Sold To", "Date"  };
